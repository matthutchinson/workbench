...
set -g status-right '#(~/tmux/segments/machine-stats)#(~/tmux/segments/travis)#(~/tmux/segments/inbox-count)#(~/tmux/segments/battery)#(~/tmux/segments/lan-ip)#[fg=colour213] %H:%M'
